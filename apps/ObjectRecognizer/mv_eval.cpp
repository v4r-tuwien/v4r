...
int main(int argc, char **argv) {
  ...
  po::options_description desc(
      "Single-View Object Instance Recognizer\n======================================\n**Allowed options");
  desc.add_options()("help,h", "produce help message")(
      ...
      "shuffle_views", po::value<bool>(&shuffle_views)->default_value(shuffle_views),
      "if true, randomly selects viewpoints. Otherwise in the sequence given by the filenames.")(
      "view_sample_size", po::value<size_t>(&view_sample_size)->default_value(view_sample_size),
      "view sample size. Only every n-th view will be recognized to speed up evaluation.");
  po::variables_map vm;
