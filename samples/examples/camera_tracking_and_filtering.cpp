...
int main(int argc, char *argv[]) {
  ...
  tsf_param.batch_size_clouds = 20;
  tsf_param.type = 3;  // 2; //3
  ...
  tsFilter.setCameraParameterTSF(intrinsic, 640, 480);
  //  tsFilter.setCameraParameterTSF(intrinsic_tsf, 1024, 768);
