...
#define PCL_INSTANTIATE_copyPointCloud(T) \
  template V4R_EXPORTS void copyPointCloud<T>(const PointCloud<T> &, const boost::dynamic_bitset<> &, PointCloud<T> &);
PCL_INSTANTIATE(copyPointCloud, PCL_XYZ_POINT_TYPES(Normal))
#undef PCL_INSTANTIATE_copyPointCloud

#define PCL_INSTANTIATE_copyPointCloud(T) \
  template V4R_EXPORTS void copyPointCloud<T>(const PointCloud<T> &, const std::vector<bool> &, PointCloud<T> &);
PCL_INSTANTIATE(copyPointCloud, PCL_XYZ_POINT_TYPES(Normal))
#undef PCL_INSTANTIATE_copyPointCloud

#define PCL_INSTANTIATE_copyPointCloud(T)      \
  template V4R_EXPORTS void copyPointCloud<T>( \
