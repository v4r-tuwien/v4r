...
Eigen::VectorXf RGB2CIELAB::do_conversion(unsigned char R, unsigned char G, unsigned char B) const {
...
void RGB2CIELAB::do_inverse_conversion(const Eigen::VectorXf &converted_color, unsigned char &R, unsigned char &G,
