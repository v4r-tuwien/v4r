...
BoundaryRelationsMeanColor::BoundaryRelationsMeanColor() : BoundaryRelationsBase() {}
...
v4r::meanVal BoundaryRelationsMeanColor::compute() {
  ...
  if (boundaryLength > 0) {
    ...
    std::printf(
        "[BoundaryRelationsMeanCurvature::compute] Warning: Number of valid points is zero: totalColorDistance: "
        "%4.3f\n",
        totalColorDistance);
