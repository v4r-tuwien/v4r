  ...
  for (unsigned int i = 0; i < relations.size(); i++) {
    ...
    if ((relations.at(i).type == STRUCTURAL_RELATIONS) && ((type == ALL_RELATIONS) || (type == STRUCTURAL_RELATIONS))) {
      ...
      if ((id_0_label == id_1_label) && (id_0_label != 0)) {
        ...
        printf(" AddGT: positive structural example (type: %u): %u-%u\n", 1, relations.at(i).id_0,
               relations.at(i).id_1);
      }

      if ((id_0_label != id_1_label) &&
          ((id_0_label != 0) || (id_1_label != 0)))  //(id_0_label != 0) && (id_1_label != 0) )//
      {
        relations.at(i).groundTruth = 0;
        printf(" AddGT: negative structural example (type: %u): %u-%u\n", 1, relations.at(i).id_0,
               relations.at(i).id_1);
      }
    } else if ((relations.at(i).type == ASSEMBLY_RELATIONS) &&
               ((type == ALL_RELATIONS) || (type == ASSEMBLY_RELATIONS))) {
      ...
      if ((as_0_label != as_1_label) &&
          ((as_0_label != 0) || (as_1_label != 0)))  //(as_0_label != 0) && (as_1_label != 0) ) //
      {
        relations.at(i).groundTruth = 0;
