...
class V4R_EXPORTS TrainingView {
 ...
 public:
  ...
  TrainingView()
  : pose_(Eigen::Matrix4f::Identity()), filename_(""), pose_filename_(""), indices_filename_(""),
    view_centroid_(Eigen::Vector3f::Zero()), self_occlusion_(0.f) {}
...
class V4R_EXPORTS Model {
 ...
 public:
   ...
   */
  void addTrainingView(const typename TrainingView<PointT>::ConstPtr &tv) {
    views_.push_back(tv);
  }

  std::vector<typename TrainingView<PointT>::ConstPtr> getTrainingViews() const {
    return views_;
  }
