...
class V4R_EXPORTS UniformSamplingSharedVoxelGrid : public pcl::Keypoint<PointInT, int> {
 ...
 public:
  ...
  : leaves_(), leaf_size_(Eigen::Vector4f::Zero()), inverse_leaf_size_(Eigen::Vector4f::Zero()),
    min_b_(Eigen::Vector4i::Zero()), max_b_(Eigen::Vector4i::Zero()), div_b_(Eigen::Vector4i::Zero()),
  ...
  void getVoxelGridValues(Eigen::Vector4f& min_p_shared, Eigen::Vector4f& max_p_shared) {
    min_p_shared = min_p;
    max_p_shared = max_p;
  }

  void setVoxelGridValues(Eigen::Vector4f& min_p_shared, Eigen::Vector4f& max_p_shared) {
