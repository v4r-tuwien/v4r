...
struct Chain<FunctionType, kNumArgs, ceres::Jet<T, N>> {
  static ceres::Jet<T, N> Rule(const FunctionType& f, const FunctionType dfdx[kNumArgs],
...
class RegistrationCostFunctor {
 ...
 public:
  ...
  bool operator()(const double* const ph, const double* const pk, double* residuals) const {
...
class RegistrationCostFunctionAutoDiff {
 ...
 public:
  ...
  template <typename T>
  bool operator()(const T* const params_h, const T* const params_k, T* residual) const {
    ...
    for (size_t i = 0; i < nl_icp->clouds_transformed_with_ip_[h_]->points.size(); i++) {
      ...
      if (jacobians != nullptr) {
        ...
        if (jacobians[0] != nullptr) {
          ...
          j1 = Ly * (x * (t49 + t50 - qzh * t11 * t13 * t33 * 2.0 + qxh * t13 * t18 * t27 * t28 * 2.0 -
                          qxh * t13 * t18 * t29 * t30 * 2.0 + qxh * t13 * t18 * t31 * t33 * 2.0) +
                     z * (t63 + t64 + t65 - qxh * t13 * t18 * t28 * t38 * 2.0 + qxh * t13 * t18 * t29 * t40 * 2.0 +
                          qxh * t13 * t18 * t33 * t39 * 2.0) -
                     y * (t48 - qrh * t11 * t13 * t33 * 2.0 - qyh * t11 * t13 * t29 * 2.0 +
                          qxh * t13 * t18 * t28 * t35 * 2.0 + qxh * t13 * t18 * t29 * t37 * 2.0 +
                          qxh * t13 * t18 * t33 * t44 * 2.0)) -
               Lz * (-x * (t54 + t55 - qxh * t11 * t13 * t42 * 2.0 + qxh * t13 * t18 * t27 * t43 * 2.0 +
                           qxh * t13 * t18 * t30 * t42 * 2.0 - qxh * t13 * t18 * t31 * t41 * 2.0) +
                     z * (t69 + t70 - qrh * t11 * t13 * t43 * 2.0 + qxh * t13 * t18 * t39 * t41 * 2.0 +
                          qxh * t13 * t18 * t38 * t43 * 2.0 + qxh * t13 * t18 * t40 * t42 * 2.0) +
                     y * (t51 + t52 + t53 + qxh * t13 * t18 * t35 * t43 * 2.0 - qxh * t13 * t18 * t37 * t42 * 2.0 -
                          qxh * t13 * t18 * t41 * t44 * 2.0)) -
               Lx * (z * (t56 + t57 - qzh * t11 * t13 * t14 * 2.0 + qxh * t13 * t17 * t18 * t39 * 2.0 -
                          qxh * t13 * t14 * t18 * t40 * 2.0 - qxh * t13 * t18 * t20 * t38 * 2.0) -
                     y * (t45 + t46 - qrh * t11 * t13 * t17 * 2.0 +
                          qxh * t13 * t17 * t18 * (t25 - qyh * qzh * 2.0) * 2.0 - qxh * t13 * t14 * t18 * t37 * 2.0 +
                          qxh * t13 * t18 * t20 * t35 * 2.0) +
                     x * (t47 - qxh * t11 * t13 * t14 * 2.0 - qzh * t11 * t13 * t17 * 2.0 +
                          qxh * t13 * t14 * t18 * t30 * 2.0 + qxh * t13 * t18 * t20 * t27 * 2.0 +
                          qxh * t13 * t17 * t18 * t31 * 2.0));
          j2 = Ly * (z * (t66 + t67 - qrh * t11 * t13 * t29 * 2.0 - qyh * t13 * t18 * t28 * t38 * 2.0 +
                          qyh * t13 * t18 * t29 * t40 * 2.0 + qyh * t13 * t18 * t33 * t39 * 2.0) -
                     y * (-t49 - t50 + t68 + qyh * t13 * t18 * t28 * t35 * 2.0 + qyh * t13 * t18 * t29 * t37 * 2.0 +
                          qyh * t13 * t18 * t33 * t44 * 2.0) +
                     x * (t48 - qrh * t11 * t13 * t33 * 2.0 - qyh * t11 * t13 * t29 * 2.0 +
                          qyh * t13 * t18 * t27 * t28 * 2.0 - qyh * t13 * t18 * t29 * t30 * 2.0 +
                          qyh * t13 * t18 * t31 * t33 * 2.0)) -
               Lx * (x * (t45 + t46 - qrh * t11 * t13 * t17 * 2.0 + qyh * t13 * t14 * t18 * t30 * 2.0 +
                          qyh * t13 * t18 * t20 * t27 * 2.0 + qyh * t13 * t17 * t18 * t31 * 2.0) +
                     z * (t58 + t59 + t60 + qyh * t13 * t17 * t18 * t39 * 2.0 - qyh * t13 * t14 * t18 * t40 * 2.0 -
                          qyh * t13 * t18 * t20 * t38 * 2.0) -
                     y * (-t47 + t61 + t62 - qyh * t13 * t14 * t18 * t37 * 2.0 + qyh * t13 * t18 * t20 * t35 * 2.0 +
                          qyh * t13 * t17 * t18 * t44 * 2.0)) +
               Lz * (y * (t54 + t55 - qxh * t11 * t13 * t42 * 2.0 - qyh * t13 * t18 * t35 * t43 * 2.0 +
                          qyh * t13 * t18 * t37 * t42 * 2.0 + qyh * t13 * t18 * t41 * t44 * 2.0) +
                     x * (t51 + t52 + t53 + qyh * t13 * t18 * t27 * t43 * 2.0 + qyh * t13 * t18 * t30 * t42 * 2.0 -
                          qyh * t13 * t18 * t31 * t41 * 2.0) -
                     z * (t71 - qrh * t11 * t13 * t42 * 2.0 - qzh * t11 * t13 * t43 * 2.0 +
                          qyh * t13 * t18 * t39 * t41 * 2.0 + qyh * t13 * t18 * t38 * t43 * 2.0 +
                          qyh * t13 * t18 * t40 * t42 * 2.0));
          j3 = Lz * (x * (t69 + t70 - qrh * t11 * t13 * t43 * 2.0 + qzh * t13 * t18 * t27 * t43 * 2.0 +
                          qzh * t13 * t18 * t30 * t42 * 2.0 - qzh * t13 * t18 * t31 * t41 * 2.0) +
                     y * (t71 - qrh * t11 * t13 * t42 * 2.0 - qzh * t11 * t13 * t43 * 2.0 -
                          qzh * t13 * t18 * t35 * t43 * 2.0 + qzh * t13 * t18 * t37 * t42 * 2.0 +
                          qzh * t13 * t18 * t41 * t44 * 2.0) -
                     z * (-t54 - t55 + qxh * t11 * t13 * t42 * 2.0 + qzh * t13 * t18 * t39 * t41 * 2.0 +
                          qzh * t13 * t18 * t38 * t43 * 2.0 + qzh * t13 * t18 * t40 * t42 * 2.0)) -
               Ly * (y * (t66 + t67 - qrh * t11 * t13 * t29 * 2.0 + qzh * t13 * t18 * t28 * t35 * 2.0 +
                          qzh * t13 * t18 * t29 * t37 * 2.0 + qzh * t13 * t18 * t33 * t44 * 2.0) +
                     x * (t63 + t64 + t65 - qzh * t13 * t18 * t27 * t28 * 2.0 + qzh * t13 * t18 * t29 * t30 * 2.0 -
                          qzh * t13 * t18 * t31 * t33 * 2.0) -
                     z * (t49 + t50 - t68 - qzh * t13 * t18 * t28 * t38 * 2.0 + qzh * t13 * t18 * t29 * t40 * 2.0 +
                          qzh * t13 * t18 * t33 * t39 * 2.0)) +
               Lx * (-x * (-t56 - t57 + t72 + qzh * t13 * t14 * t18 * t30 * 2.0 + qzh * t13 * t18 * t20 * t27 * 2.0 +
                           qzh * t13 * t17 * t18 * t31 * 2.0) +
                     y * (t58 + t59 + t60 - qzh * t13 * t14 * t18 * t37 * 2.0 + qzh * t13 * t18 * t20 * t35 * 2.0 +
                          qzh * t13 * t17 * t18 * t44 * 2.0) +
                     z * (-t47 + t61 + t62 - qzh * t13 * t17 * t18 * t39 * 2.0 + qzh * t13 * t14 * t18 * t40 * 2.0 +
                          qzh * t13 * t18 * t20 * t38 * 2.0));
          j4 = -Lx * (z * (t45 + t46 - qrh * t11 * t13 * t17 * 2.0 + qrh * t13 * t17 * t18 * t39 * 2.0 -
                           qrh * t13 * t14 * t18 * t40 * 2.0 - qrh * t13 * t18 * t20 * t38 * 2.0) -
                      x * (t58 + t59 + t60 - qrh * t13 * t14 * t18 * t30 * 2.0 - qrh * t13 * t18 * t20 * t27 * 2.0 -
                           qrh * t13 * t17 * t18 * t31 * 2.0) +
                      y * (t56 + t57 - t72 + qrh * t13 * t14 * t18 * t37 * 2.0 - qrh * t13 * t18 * t20 * t35 * 2.0 -
                           qrh * t13 * t17 * t18 * t44 * 2.0)) +
               Ly * (-x * (t66 + t67 - qrh * t11 * t13 * t29 * 2.0 - qrh * t13 * t18 * t27 * t28 * 2.0 +
                           qrh * t13 * t18 * t29 * t30 * 2.0 - qrh * t13 * t18 * t31 * t33 * 2.0) +
                     y * (t63 + t64 + t65 - qrh * t13 * t18 * t28 * t35 * 2.0 - qrh * t13 * t18 * t29 * t37 * 2.0 -
                          qrh * t13 * t18 * t33 * t44 * 2.0) +
                     z * (t48 - qrh * t11 * t13 * t33 * 2.0 - qyh * t11 * t13 * t29 * 2.0 -
                          qrh * t13 * t18 * t28 * t38 * 2.0 + qrh * t13 * t18 * t29 * t40 * 2.0 +
                          qrh * t13 * t18 * t33 * t39 * 2.0)) +
               Lz * (-y * (t69 + t70 - qrh * t11 * t13 * t43 * 2.0 + qrh * t13 * t18 * t35 * t43 * 2.0 -
                           qrh * t13 * t18 * t37 * t42 * 2.0 - qrh * t13 * t18 * t41 * t44 * 2.0) +
                     z * (t51 + t52 + t53 - qrh * t13 * t18 * t39 * t41 * 2.0 - qrh * t13 * t18 * t38 * t43 * 2.0 -
                          qrh * t13 * t18 * t40 * t42 * 2.0) +
                     x * (t71 - qrh * t11 * t13 * t42 * 2.0 - qzh * t11 * t13 * t43 * 2.0 +
                          qrh * t13 * t18 * t27 * t43 * 2.0 + qrh * t13 * t18 * t30 * t42 * 2.0 -
                          qrh * t13 * t18 * t31 * t41 * 2.0));
        ...
        if (jacobians[1] != nullptr) {
          ...
          j8 = Lx * (t149 + t150 + t151 +
                     y * (t145 + t146 - qzk * t83 * t85 * t97 * 2.0 - qxk * t100 * t114 * t85 * t89 * 2.0 +
                          qxk * t115 * t85 * t89 * t94 * 2.0 + qxk * t116 * t85 * t89 * t97 * 2.0) +
                     z * (t147 + t148 - qxk * t108 * t83 * t85 * 2.0 + qxk * t105 * t115 * t85 * t89 * 2.0 +
                          qxk * t108 * t114 * t85 * t89 * 2.0 - qxk * t107 * t116 * t85 * t89 * 2.0) -
                     t143 * t83 -
                     x * (t144 - qxk * t83 * t85 * t88 * 2.0 - qzk * t83 * t85 * t92 * 2.0 +
                          qxk * t115 * t85 * t87 * t89 * 2.0 + qxk * t114 * t85 * t88 * t89 * 2.0 +
                          qxk * t116 * t85 * t89 * t92 * 2.0) +
                     qxk * t133 * t89 * 2.0 - qxk * t114 * t89 * txh * 2.0 + qxk * t115 * t89 * tyh * 2.0 -
                     qxk * t116 * t89 * tzh * 2.0) -
               Lz * (t161 + t169 +
                     x * (t162 + t163 - qzk * t83 * t85 * t88 * 2.0 - qxk * t110 * t85 * t87 * t89 * 2.0 -
                          qxk * t112 * t85 * t88 * t89 * 2.0 + qxk * t109 * t85 * t89 * t92 * 2.0) +
                     z * (t167 + t168 - qrk * t105 * t83 * t85 * 2.0 + qxk * t107 * t109 * t85 * t89 * 2.0 +
                          qxk * t105 * t110 * t85 * t89 * 2.0 + qxk * t108 * t112 * t85 * t89 * 2.0) -
                     y * (t164 + t165 + t166 + qxk * t100 * t112 * t85 * t89 * 2.0 -
                          qxk * t110 * t85 * t89 * t94 * 2.0 + qxk * t109 * t85 * t89 * t97 * 2.0) -
                     qxk * t139 * t89 * 2.0 - qrk * t83 * tyh * 2.0 - qzk * t83 * txh * 2.0 -
                     qxk * t112 * t89 * txh * 2.0 + qxk * t110 * t89 * tyh * 2.0 + qxk * t109 * t89 * tzh * 2.0) -
               Ly * (t126 + t127 -
                     x * (t120 + t121 - qrk * t83 * t85 * t92 * 2.0 - qxk * t103 * t85 * t88 * t89 * 2.0 +
                          qxk * t85 * t87 * t89 * t95 * 2.0 + qxk * t85 * t89 * t92 * t99 * 2.0) -
                     t119 * t83 +
                     z * (t123 + t124 + t125 - qxk * t103 * t108 * t85 * t89 * 2.0 +
                          qxk * t105 * t85 * t89 * t95 * 2.0 - qxk * t107 * t85 * t89 * t99 * 2.0) +
                     y * (t122 - qyk * t100 * t83 * t85 * 2.0 - qrk * t83 * t85 * t97 * 2.0 +
                          qxk * t100 * t103 * t85 * t89 * 2.0 + qxk * t85 * t89 * t94 * t95 * 2.0 +
                          qxk * t85 * t89 * t97 * t99 * 2.0) -
                     qxk * t157 * t89 * 2.0 - qyk * t83 * txh * 2.0 + qxk * t103 * t89 * txh * 2.0 +
                     qxk * t89 * t95 * tyh * 2.0 - qxk * t89 * t99 * tzh * 2.0);
          j9 = Ly * (t149 + t150 + t151 +
                     z * (t147 + t148 - qxk * t108 * t83 * t85 * 2.0 + qyk * t103 * t108 * t85 * t89 * 2.0 -
                          qyk * t105 * t85 * t89 * t95 * 2.0 + qyk * t107 * t85 * t89 * t99 * 2.0) -
                     y * (-t145 - t146 + t189 + qyk * t100 * t103 * t85 * t89 * 2.0 +
                          qyk * t85 * t89 * t94 * t95 * 2.0 + qyk * t85 * t89 * t97 * t99 * 2.0) -
                     t143 * t83 +
                     x * (-t144 + t187 + t188 - qyk * t103 * t85 * t88 * t89 * 2.0 + qyk * t85 * t87 * t89 * t95 * 2.0 +
                          qyk * t85 * t89 * t92 * t99 * 2.0) +
                     qyk * t157 * t89 * 2.0 - qyk * t103 * t89 * txh * 2.0 - qyk * t89 * t95 * tyh * 2.0 +
                     qyk * t89 * t99 * tzh * 2.0) -
               Lz * (t182 + t183 -
                     y * (t179 + t180 - qrk * t100 * t83 * t85 * 2.0 + qyk * t100 * t112 * t85 * t89 * 2.0 -
                          qyk * t110 * t85 * t89 * t94 * 2.0 + qyk * t109 * t85 * t89 * t97 * 2.0) -
                     t175 * t83 +
                     x * (t176 + t177 + t178 - qyk * t110 * t85 * t87 * t89 * 2.0 - qyk * t112 * t85 * t88 * t89 * 2.0 +
                          qyk * t109 * t85 * t89 * t92 * 2.0) +
                     z * (t181 - qrk * t108 * t83 * t85 * 2.0 - qzk * t105 * t83 * t85 * 2.0 +
                          qyk * t107 * t109 * t85 * t89 * 2.0 + qyk * t105 * t110 * t85 * t89 * 2.0 +
                          qyk * t108 * t112 * t85 * t89 * 2.0) -
                     qyk * t139 * t89 * 2.0 - qzk * t83 * tyh * 2.0 - qyk * t112 * t89 * txh * 2.0 +
                     qyk * t110 * t89 * tyh * 2.0 + qyk * t109 * t89 * tzh * 2.0) +
               Lx * (t126 + t127 -
                     x * (t120 + t121 - qrk * t83 * t85 * t92 * 2.0 + qyk * t115 * t85 * t87 * t89 * 2.0 +
                          qyk * t114 * t85 * t88 * t89 * 2.0 + qyk * t116 * t85 * t89 * t92 * 2.0) -
                     t119 * t83 +
                     z * (t123 + t124 + t125 + qyk * t105 * t115 * t85 * t89 * 2.0 +
                          qyk * t108 * t114 * t85 * t89 * 2.0 - qyk * t107 * t116 * t85 * t89 * 2.0) +
                     y * (t122 - qyk * t100 * t83 * t85 * 2.0 - qrk * t83 * t85 * t97 * 2.0 -
                          qyk * t100 * t114 * t85 * t89 * 2.0 + qyk * t115 * t85 * t89 * t94 * 2.0 +
                          qyk * t116 * t85 * t89 * t97 * 2.0) +
                     qyk * t133 * t89 * 2.0 - qyk * t83 * txh * 2.0 - qyk * t114 * t89 * txh * 2.0 +
                     qyk * t115 * t89 * tyh * 2.0 - qyk * t116 * t89 * tzh * 2.0);
          j10 = Lz * (t149 + t150 + t151 - t143 * t83 +
                      x * (-t144 + t187 + t188 + qzk * t110 * t85 * t87 * t89 * 2.0 +
                           qzk * t112 * t85 * t88 * t89 * 2.0 - qzk * t109 * t85 * t89 * t92 * 2.0) +
                      y * (t145 + t146 - t189 + qzk * t100 * t112 * t85 * t89 * 2.0 -
                           qzk * t110 * t85 * t89 * t94 * 2.0 + qzk * t109 * t85 * t89 * t97 * 2.0) -
                      z * (-t147 - t148 + qxk * t108 * t83 * t85 * 2.0 + qzk * t107 * t109 * t85 * t89 * 2.0 +
                           qzk * t105 * t110 * t85 * t89 * 2.0 + qzk * t108 * t112 * t85 * t89 * 2.0) +
                      qzk * t139 * t89 * 2.0 + qzk * t112 * t89 * txh * 2.0 - qzk * t110 * t89 * tyh * 2.0 -
                      qzk * t109 * t89 * tzh * 2.0) -
                Lx * (-t161 - t169 + t196 + t197 -
                      z * (t167 + t168 - qrk * t105 * t83 * t85 * 2.0 + qzk * t105 * t115 * t85 * t89 * 2.0 +
                           qzk * t108 * t114 * t85 * t89 * 2.0 - qzk * t107 * t116 * t85 * t89 * 2.0) +
                      x * (-t162 - t163 + t195 + qzk * t115 * t85 * t87 * t89 * 2.0 +
                           qzk * t114 * t85 * t88 * t89 * 2.0 + qzk * t116 * t85 * t89 * t92 * 2.0) +
                      y * (t164 + t165 + t166 + qzk * t100 * t114 * t85 * t89 * 2.0 -
                           qzk * t115 * t85 * t89 * t94 * 2.0 - qzk * t116 * t85 * t89 * t97 * 2.0) -
                      qzk * t133 * t89 * 2.0 + qzk * t114 * t89 * txh * 2.0 - qzk * t115 * t89 * tyh * 2.0 +
                      qzk * t116 * t89 * tzh * 2.0) +
                Ly * (t182 + t183 -
                      y * (t179 + t180 - qrk * t100 * t83 * t85 * 2.0 + qzk * t100 * t103 * t85 * t89 * 2.0 +
                           qzk * t85 * t89 * t94 * t95 * 2.0 + qzk * t85 * t89 * t97 * t99 * 2.0) -
                      t175 * t83 +
                      x * (t176 + t177 + t178 - qzk * t103 * t85 * t88 * t89 * 2.0 + qzk * t85 * t87 * t89 * t95 * 2.0 +
                           qzk * t85 * t89 * t92 * t99 * 2.0) +
                      z * (t181 - qrk * t108 * t83 * t85 * 2.0 - qzk * t105 * t83 * t85 * 2.0 +
                           qzk * t103 * t108 * t85 * t89 * 2.0 - qzk * t105 * t85 * t89 * t95 * 2.0 +
                           qzk * t107 * t85 * t89 * t99 * 2.0) +
                      qzk * t157 * t89 * 2.0 - qzk * t83 * tyh * 2.0 - qzk * t103 * t89 * txh * 2.0 -
                      qzk * t89 * t95 * tyh * 2.0 + qzk * t89 * t99 * tzh * 2.0);
          j11 = -Ly * (t161 + t169 - t196 - t197 +
                       z * (t167 + t168 - qrk * t105 * t83 * t85 * 2.0 - qrk * t103 * t108 * t85 * t89 * 2.0 +
                            qrk * t105 * t85 * t89 * t95 * 2.0 - qrk * t107 * t85 * t89 * t99 * 2.0) -
                       y * (t164 + t165 + t166 - qrk * t100 * t103 * t85 * t89 * 2.0 -
                            qrk * t85 * t89 * t94 * t95 * 2.0 - qrk * t85 * t89 * t97 * t99 * 2.0) +
                       x * (t162 + t163 - t195 + qrk * t103 * t85 * t88 * t89 * 2.0 -
                            qrk * t85 * t87 * t89 * t95 * 2.0 - qrk * t85 * t89 * t92 * t99 * 2.0) -
                       qrk * t157 * t89 * 2.0 + qrk * t103 * t89 * txh * 2.0 + qrk * t89 * t95 * tyh * 2.0 -
                       qrk * t89 * t99 * tzh * 2.0) +
                Lx * (t182 + t183 -
                      y * (t179 + t180 - qrk * t100 * t83 * t85 * 2.0 + qrk * t100 * t114 * t85 * t89 * 2.0 -
                           qrk * t115 * t85 * t89 * t94 * 2.0 - qrk * t116 * t85 * t89 * t97 * 2.0) -
                      t175 * t83 +
                      x * (t176 + t177 + t178 - qrk * t115 * t85 * t87 * t89 * 2.0 -
                           qrk * t114 * t85 * t88 * t89 * 2.0 - qrk * t116 * t85 * t89 * t92 * 2.0) +
                      z * (t181 - qrk * t108 * t83 * t85 * 2.0 - qzk * t105 * t83 * t85 * 2.0 +
                           qrk * t105 * t115 * t85 * t89 * 2.0 + qrk * t108 * t114 * t85 * t89 * 2.0 -
                           qrk * t107 * t116 * t85 * t89 * 2.0) +
                      qrk * t133 * t89 * 2.0 - qzk * t83 * tyh * 2.0 - qrk * t114 * t89 * txh * 2.0 +
                      qrk * t115 * t89 * tyh * 2.0 - qrk * t116 * t89 * tzh * 2.0) +
                Lz * (t126 + t127 -
                      x * (t120 + t121 - qrk * t83 * t85 * t92 * 2.0 - qrk * t110 * t85 * t87 * t89 * 2.0 -
                           qrk * t112 * t85 * t88 * t89 * 2.0 + qrk * t109 * t85 * t89 * t92 * 2.0) -
                      t119 * t83 +
                      z * (t123 + t124 + t125 - qrk * t107 * t109 * t85 * t89 * 2.0 -
                           qrk * t105 * t110 * t85 * t89 * 2.0 - qrk * t108 * t112 * t85 * t89 * 2.0) +
                      y * (t122 - qyk * t100 * t83 * t85 * 2.0 - qrk * t83 * t85 * t97 * 2.0 +
                           qrk * t100 * t112 * t85 * t89 * 2.0 - qrk * t110 * t85 * t89 * t94 * 2.0 +
                           qrk * t109 * t85 * t89 * t97 * 2.0) +
                      qrk * t139 * t89 * 2.0 - qyk * t83 * txh * 2.0 + qrk * t112 * t89 * txh * 2.0 -
                      qrk * t110 * t89 * tyh * 2.0 - qrk * t109 * t89 * tzh * 2.0);
...
template <class PointT>
void v4r::Registration::MvLMIcp<PointT>::compute() {
  ...
  if (diff_type == 1) {
    ...
    for (size_t i = 0; i < clouds_.size(); i++) {
      typename pcl::PointCloud<PointT>::ConstPtr cloud_const(
          new pcl::PointCloud<PointT>(*clouds_transformed_with_ip_[i]));
      ...
      case 0: {
        ceres::CostFunction* cost_function =
            new ceres::NumericDiffCostFunction<RegistrationCostFunctor<PointT>, ceres::CENTRAL, ceres::DYNAMIC, 6, 6>(
                new RegistrationCostFunctor<PointT>(this, S_[i].first, S_[i].second), ceres::TAKE_OWNERSHIP,
  ...
  for (size_t i = 0; i < clouds_.size(); i++) {
    switch (diff_type) {
      case 0: {
        Eigen::Vector3d trans(parameters[i * params_per_view + 3], parameters[i * params_per_view + 4],
                              parameters[i * params_per_view + 5]);
        Eigen::Matrix3d R;
      ...
      default: {
        Eigen::Quaterniond rot(parameters[i * params_per_view + 3], parameters[i * params_per_view],
                               parameters[i * params_per_view + 1], parameters[i * params_per_view + 2]);
        Eigen::Vector3d trans(parameters[i * params_per_view + 4], parameters[i * params_per_view + 5],
                              parameters[i * params_per_view + 6]);
...
template <class PointT>
void v4r::Registration::MvLMIcp<PointT>::fillViewParList() {
  for (size_t i = 0; i < clouds_.size(); i++) {
    for (size_t j = (i + 1); j < clouds_.size(); j++) {
