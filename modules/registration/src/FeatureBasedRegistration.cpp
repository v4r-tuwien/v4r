...
template <class PointT>
void FeatureBasedRegistration<PointT>::compute(int s1, int s2) {
  ...
  std::cout << kps_s1->points.size() << " " << model_features_[s1].size() << " " << normals_s1->points.size()
            << std::endl;
  std::cout << kps_s2->points.size() << " " << model_features_[s2].size() << " " << normals_s2->points.size()
            << std::endl;
