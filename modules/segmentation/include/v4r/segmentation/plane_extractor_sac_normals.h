...
/**
 * @file plane_extractor_sac_normals.h
 * @author Thomas Faeulhammer (faeulhammer@acin.tuwien.ac.at)
 * @date 2017
 * @brief SAC based plane extractor
 *
 */
...
class V4R_EXPORTS SACNormalsPlaneExtractor : public PlaneExtractor<PointT> {
 ...
 public:
  SACNormalsPlaneExtractor(const PlaneExtractorParameter &p = PlaneExtractorParameter()) : PlaneExtractor<PointT>(p) {
    max_z_bounds_ = 1.5;
    k_ = 50;
