...
void ClusterNormalsToPlanesPCL<PointT>::clusterNormals(const typename pcl::PointCloud<PointT>::ConstPtr &cloud,
                                                       const pcl::PointCloud<pcl::Normal> &normals, size_t idx,
...
template <typename PointT>
void ClusterNormalsToPlanesPCL<PointT>::clusterNormalsUnorganized(
    const typename pcl::PointCloud<PointT>::ConstPtr &cloud, const pcl::PointCloud<pcl::Normal> &normals, size_t idx,
    typename ClusterNormalsToPlanesPCL<PointT>::Plane &plane) {
  mask_[idx] = false;
 ...
 */
template <typename PointT>
void ClusterNormalsToPlanesPCL<PointT>::smoothClustering(const typename pcl::PointCloud<PointT>::ConstPtr &cloud,
                                                         const pcl::PointCloud<pcl::Normal> &normals, size_t idx,
                                                         typename ClusterNormalsToPlanesPCL<PointT>::Plane &plane) {
  plane.clear();
 ...
 */
template <typename PointT>
void ClusterNormalsToPlanesPCL<PointT>::doClustering(
    const typename pcl::PointCloud<PointT>::ConstPtr &cloud, const pcl::PointCloud<pcl::Normal> &normals,
 ...
 */
template <typename PointT>
void ClusterNormalsToPlanesPCL<PointT>::compute(const typename pcl::PointCloud<PointT>::ConstPtr &_cloud,
                                                const pcl::PointCloud<pcl::Normal> &_normals,
 ...
 */
template <typename PointT>
void ClusterNormalsToPlanesPCL<PointT>::compute(const typename pcl::PointCloud<PointT>::ConstPtr &cloud,
                                                const pcl::PointCloud<pcl::Normal> &normals, int x, int y,
                                                PlaneModel<PointT> &pm) {
  mask_.clear();
