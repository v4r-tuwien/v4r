 ...
 */
ComputeImGDescOrientations::ComputeImGDescOrientations(const Parameter &p) : param(p) {
 ...
 * compute descriptors
 */
void ComputeImGDescOrientations::compute(const cv::Mat_<unsigned char> &image, const std::vector<cv::Point2f> &pts,
