...
class V4R_EXPORTS GlobalColorEstimatorParameter {
 public:
  ...
  float std_dev_multiplier_;  ///< multiplication factor of the standard deviation of the color channel for minimum and
                              /// maximum range of color histogram
  GlobalColorEstimatorParameter() : num_bins(15), std_dev_multiplier_(3.f) {}
