 ...
 public:
  class V4R_EXPORTS Parameter {
   public:
    ...
    Parameter(int _nfeatures = 1000, float _scaleFactor = 1.44, int _nlevels = 2, int _patchSize = 17, int _tiles = 1,
    ...
    : nfeatures(_nfeatures), scaleFactor(_scaleFactor), nlevels(_nlevels), patchSize(_patchSize), tiles(_tiles),
      gdParam(_gdParam), do_feature_selection(_do_feature_selection) {}
  };
