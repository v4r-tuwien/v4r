 ...
 */
PlaneEstimationRANSAC::PlaneEstimationRANSAC(const Parameter &p) : param(p) {}
 ...
 * GetDistances
 */
void PlaneEstimationRANSAC::getDistances(const std::vector<Eigen::Vector3f> &pts, const Eigen::Vector3f &pt,
                                         const Eigen::Vector3f &n, std::vector<float> &dists) {
 ...
 */
void PlaneEstimationRANSAC::ransac(const std::vector<Eigen::Vector3f> &pts, Eigen::Vector3f &pt, Eigen::Vector3f &n,
 ...
 */
void PlaneEstimationRANSAC::computeCovarianceMatrix(const std::vector<Eigen::Vector3f> &pts,
 ...
 */
void PlaneEstimationRANSAC::estimatePlaneLS(const std::vector<Eigen::Vector3f> &pts, const std::vector<int> &indices,
