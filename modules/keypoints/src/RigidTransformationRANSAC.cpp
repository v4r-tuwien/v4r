 ...
 */
RigidTransformationRANSAC::RigidTransformationRANSAC(Parameter p) : param(p) {}
 ...
 * GetDistances
 */
void RigidTransformationRANSAC::GetDistances(const std::vector<Eigen::Vector3f> &srcPts,
 ...
 */
int RigidTransformationRANSAC::Ransac(const std::vector<Eigen::Vector3f> &srcPts,
 ...
 * ComputeCentroid
 */
void RigidTransformationRANSAC::ComputeCentroid(const std::vector<Eigen::Vector3f> &pts,
                                                const std::vector<int> &indices, Eigen::Vector3f &centroid) {
  // Initialize to 0
  centroid.setZero();
 ...
 * DemeanPoints
 */
void RigidTransformationRANSAC::DemeanPoints(const std::vector<Eigen::Vector3f> &inPts, const std::vector<int> &indices,
 ...
 */
void RigidTransformationRANSAC::estimateRigidTransformationSVD(const std::vector<Eigen::Vector3f> &srcPts,
 ...
 * compute
 */
int RigidTransformationRANSAC::compute(const std::vector<Eigen::Vector3f> &srcPts,
                                       const std::vector<Eigen::Vector3f> &tgtPts, Eigen::Matrix4f &transform,
                                       std::vector<int> &inliers) {
