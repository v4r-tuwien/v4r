...
class V4R_EXPORTS EntangledForestFeatureExtraction {
 private:
  ...
  void CalculatePairwiseFeatures(std::vector<Eigen::Vector3f>& centroids, std::vector<Eigen::Vector3f>& normals,
                                 std::vector<double>& verticalAngles);
  void CalculatePairwiseFeaturesOctree(std::vector<Eigen::Vector3f>& centroids, std::vector<Eigen::Vector3f>& normals,
                                       std::vector<double>& verticalAngles);
 ...
 public:
  ...
  void setInputCloud(pcl::PointCloud<pcl::PointXYZRGB>::ConstPtr input, pcl::PointCloud<pcl::Normal>::ConstPtr normals,
                     pcl::PointCloud<pcl::PointXYZL>::ConstPtr labels, int nlabels);
  ...
  void getFeatures(std::vector<std::vector<double>>& unaries, std::vector<std::vector<std::pair<double, int>>>& ptpl,
